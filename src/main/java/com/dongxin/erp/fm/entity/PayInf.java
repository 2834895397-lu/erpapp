...
public class PayInf implements Serializable {
	...
	/**单据状态*/
	@Excel(name = "单据状态", width = 15,dicCode = "fm_pay_status")
    @Dict(dicCode = "fm_pay_status")
    ...
    @Excel(name = "付款性质名称", width = 15)
    @ApiModelProperty(value = "付款性质名称")
    private java.lang.String payNatureName;
