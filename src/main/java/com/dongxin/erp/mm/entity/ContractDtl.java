...
@Data
@TableName("tmm_contract_dtl")
public class ContractDtl implements Serializable {
	...
	/**采购申请明细表ID*/
	@Excel(name = "采购申请明细表ID", width = 15)
	@ApiModelProperty(value = "采购申请明细表ID")
	private java.lang.String tmmPurchasePlanDtlId;
	/**备注*/
