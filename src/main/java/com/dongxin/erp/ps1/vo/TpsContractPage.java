package com.dongxin.erp.ps1.vo;
 ...
 */
@Data
@ApiModel(value="tps_contractPage对象", description="合同信息表")
public class TpsContractPage {
	...
	@ExcelCollection(name="合同资金表")
	@ApiModelProperty(value = "合同资金表")
	private List<TpsContractFund> tpsContractFundList;
