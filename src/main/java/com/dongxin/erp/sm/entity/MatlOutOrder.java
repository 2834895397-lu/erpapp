...
@Data
@TableName("tsm_matl_out_order")
public class MatlOutOrder implements Serializable {
    ...
    /**领用单单据号*/
    @Excel(name = "领用单单据号", width = 15)
    @ApiModelProperty(value = "领用单单据号")
    @TableField(fill = FieldFill.INSERT)
    private String matlOutNumber;
