 ...
 */
@Data
@TableName("tsm_matl_stock")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="tsm_matl_stock对象", description="总结存表")
public class MatlStock implements Serializable {
	...
	/**结存日期*/
	@Excel(name = "结存日期", width = 15, format = "yyyy-MM-dd")
	@JsonFormat(timezone = "GMT+8",pattern = "yyyy-MM-dd")
    @DateTimeFormat(pattern="yyyy-MM-dd")
    @ApiModelProperty(value = "结存日期")
