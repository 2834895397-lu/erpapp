 ...
 */
@Data
@ApiModel(value="tsm_matl_move_orderPage对象", description="移库单主表")
public class MatlMoveOrderPage {
	...
	@ExcelCollection(name="移库单明细表")
	@ApiModelProperty(value = "移库单明细表")
	private List<MatlMoveOrderDtl> matlMoveOrderDtlList;
